...
class Set(Collection[_T_co], Generic[_T_co]):  # typing.AbstractSet
    @abstractmethod
    def __contains__(self, x: object) -> bool: ...
    # Mixin methods
    ...
    def __or__(self, s: Set[_T]) -> Set[_T_co | _T]: ...
    def __sub__(self, s: Set[Any]) -> Set[_T_co]: ...
    def __xor__(self, s: Set[_T]) -> Set[_T_co | _T]: ...
    def isdisjoint(self, other: Iterable[Any]) -> bool: ...

class MutableSet(Set[_T], Generic[_T]):
    @abstractmethod
    ...
    def pop(self) -> _T: ...
    def remove(self, value: _T) -> None: ...
    def __ior__(self, s: Set[_S]) -> MutableSet[_T | _S]: ...
    def __iand__(self, s: Set[Any]) -> MutableSet[_T]: ...
    def __ixor__(self, s: Set[_S]) -> MutableSet[_T | _S]: ...
    def __isub__(self, s: Set[Any]) -> MutableSet[_T]: ...

class MappingView(Sized):
    def __init__(self, mapping: Mapping[Any, Any]) -> None: ...  # undocumented
    def __len__(self) -> int: ...

class ItemsView(MappingView, Set[typing.Tuple[_KT_co, _VT_co]], Generic[_KT_co, _VT_co]):
...
class KeysView(MappingView, Set[_KT_co], Generic[_KT_co]):
