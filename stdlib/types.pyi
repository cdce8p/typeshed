...
class GeneratorType:
    ...
    @overload
    def throw(
        self, __typ: Type[BaseException], __val: tUnion[BaseException, object] = ..., __tb: Optional[TracebackType] = ...
    ) -> Any: ...
    @overload
...
class BuiltinFunctionType:
    __self__: tUnion[object, ModuleType]
    __name__: str
    __qualname__: str
    def __call__(self, *args: Any, **kwargs: Any) -> Any: ...
...
if sys.version_info >= (3, 9):
    class GenericAlias:
        ...
        if sys.version_info >= (3, 10):
            def __or__(self, right: type) -> tUnion: ...
            def __ror__(self, right: type) -> tUnion: ...
